...
Upload your function to [gist.github.com](gist.github.com) (an easy way to share short code files) and download your neighbor's code. Can you cause their function to return an unexpected result?
...
col_means <- function(df) {
  assert_that(is.data.frame(df)) # Check input is a data frame
  numeric <- sapply(df, is.numeric)
...
col_means <- function(df) {
  assert_data_frame(df) # Check input is a data frame
  numeric <- sapply(df, is.numeric)
